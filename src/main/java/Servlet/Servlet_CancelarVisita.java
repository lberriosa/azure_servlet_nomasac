 ...
 * @author lberr
 */
@WebServlet(name = "Servlet_CancelarVisita", urlPatterns = {"/Servlet_CancelarVisita"})
public class Servlet_CancelarVisita extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean respuesta = Actividad_DB.CancelarVisita(ac, ida, se, ids);

            if (respuesta) {
                Usuario user = Usuario_DB.BuscarUsuarioRut(rut_user);
                String destinatario = user.getCorreo_usuario();
                String asunto = "Visita Cancelada en Sistema";
                String cuerpo = "Se realizo la cancelación de una visita para su empresa, Si no solicito acción favor comunicarse con un supervisor.";
