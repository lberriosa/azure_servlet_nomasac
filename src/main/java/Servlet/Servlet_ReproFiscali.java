 ...
 * @author lberr
 */
@WebServlet(name = "Servlet_ReproFiscali", urlPatterns = {"/Servlet_ReproFiscali"})
public class Servlet_ReproFiscali extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String desc_actividad = "Reprogramada - Visita excepcional por informe de fiscalización ";
        int es = 2;
        ...
        if(contador > 0){
            ...
            if(respuesta){
                ...
                String cuerpo = "Supervisores evaluaron caso de fiscalizacion y formularon la reprogramación de una visita para su empresa, ya puede ingresar al sistema para visualizar y gestionar actividad. Si no corresponde acción favor comunicarse con un supervisor.";
