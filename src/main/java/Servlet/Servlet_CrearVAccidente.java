 ...
 * @author lberr
 */
@WebServlet(name = "Servlet_CrearVAccidente", urlPatterns = {"/Servlet_CrearVAccidente"})
public class Servlet_CrearVAccidente extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(contador > 0){
            ...
            if(respuesta){
                ...
                String cuerpo = "Supervisores evaluaron caso de accidente y formularon la creación de una visita para su empresa, ya puede ingresar al sistema para visualizar y gestionar actividad. Si no corresponde visita favor comunicarse con un supervisor.";
