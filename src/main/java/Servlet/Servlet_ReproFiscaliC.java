 ...
 * @author lberr
 */
@WebServlet(name = "Servlet_ReproFiscaliC", urlPatterns = {"/Servlet_ReproFiscaliC"})
public class Servlet_ReproFiscaliC extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(contador > 0){
            ...
            if(respuesta){
                ...
                String cuerpo = "Se genero correctamente la reprogramación de una visita para su empresa, ya puede ingresar al sistema para visualizar y gestionar actividad. Si no corresponde acción favor comunicarse con un supervisor.";
