 ...
 * @author lberr
 */
@WebServlet(name = "Servlet_CancelarActividadAlC", urlPatterns = {"/Servlet_CancelarActividadAlC"})
public class Servlet_CancelarActividadAlC extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (respuesta) {
                ...
                String cuerpo = "Realizo correctamente la cancelación de una actividad para su empresa. Si no realizo acción favor comunicarse con un supervisor.";
