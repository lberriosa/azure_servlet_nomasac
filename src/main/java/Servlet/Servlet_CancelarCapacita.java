 ...
 * @author lberr
 */
@WebServlet(name = "Servlet_CancelarCapacita", urlPatterns = {"/Servlet_CancelarCapacita"})
public class Servlet_CancelarCapacita extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean respuesta = Actividad_DB.CancelarCapaci(ac, ida, se, ids);

            if (respuesta) {
                Usuario user = Usuario_DB.BuscarUsuarioRut(rut_user);
                String destinatario = user.getCorreo_usuario();
                String asunto = "Capacitacion Cancelada en Sistema";
                String cuerpo = "Se realizo la cancelación de una capacitación para su empresa, Si no solicito acción favor comunicarse con un supervisor.";
