 ...
 * @author lberr
 */
@WebServlet(name = "Servlet_CrearAccidente", urlPatterns = {"/Servlet_CrearAccidente"})
public class Servlet_CrearAccidente extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String n_servicio = "Accidente";
        String d_servicio = "Servicio correspondiente al informe de accidente";
        int v_servicio = 0;
        ...
        String d_pago = "Servicio correspondiente al informe de accidente";
        int v_pago = 0;
        ...
        if (cantidad < 11) {
            ...
            if (respuesta) {
                ...
                String asunto = "Se informo correctamente un accidente";
                String cuerpo = "Hemos recibido correctamente la alerta de un accidente en su empresa. Supervisor agendara visita a su empresa lo antes posible, se avisara cuando este disponible la fecha de visita y la opción de gestionar actividad. Si no corresponde alerta favor comunicarse con un supervisor.";
