 ...
 * @author lberr
 */
@WebServlet(name = "Servlet_CrearVisita", urlPatterns = {"/Servlet_CrearVisita"})
public class Servlet_CrearVisita extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String nomb_serv = "Visita";
        String nomb_activ = "Visita";
        int valor_serv = 0;
        String desc_serv = "Servicio correspondiente a visita de empresa.";
        String desc_pago = "Pago correspondiente a visita de empresa.";
        ...
        int existe = Actividad_DB.BuscarVisitaxUsuarioF(rut_visita, a);
        int cantidad = Actividad_DB.BuscarVisitaxUsuarioM(rut_visita, a);
        ...
        try {
            ...
            if (cantidad >= 2) {
                ...
                if (existe > 0) {
                    ...
                    boolean respuesta = Actividad_DB.RegistrarVisita(rut_visita, a);
                    ...
                    if (respuesta) {
                        ...
                        String cuerpo = "Se realizo la creación de una visita para su empresa, ya puede ingresar al sistema para visualizar y gestionar actividad. Si no corresponde visita favor comunicarse con un supervisor.";
