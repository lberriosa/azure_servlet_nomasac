 ...
 * @author lberr
 */
@WebServlet(name = "Servlet_EditarProfesional", urlPatterns = {"/Servlet_EditarProfesional"})
public class Servlet_EditarProfesional extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String prou = request.getParameter("pro_user");
        ...
        try {
            ...
            if (user.equals(usu.getRut_usuario())) {
                    boolean respuesta_datos = Usuario_DB.ActualizarUsuarioProfesional(u);
                    if (respuesta_datos) {
                        boolean respuesta_estado = Usuario_DB.ActualizarProfesion(u);
                        if(respuesta_estado){
                            String destinatario = coru;
                            String asunto = "Se realizo un cambio de datos";
                            String cuerpo = "Se realizo el cambio de datos relacionados a la información personal del usuario. Si no realizo esta acción favor comunicarse con su administrador.";
