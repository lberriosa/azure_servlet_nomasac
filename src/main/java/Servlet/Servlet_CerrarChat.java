    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (respuesta) {
                ...
                String cuerpo = "Se realizo el cierre de una conversación quedando en conformidad caso, Si no solicito acción favor comunicarse con un supervisor. RECUERDE QUE PUEDE ACCEDER A ESTA FUNCION LAS VECES QUE LO DESEE";
