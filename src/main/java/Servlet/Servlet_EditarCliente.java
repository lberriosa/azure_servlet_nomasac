 ...
 * @author lberr
 */
@WebServlet(name = "Servlet_EditarCliente", urlPatterns = {"/Servlet_EditarCliente"})
public class Servlet_EditarCliente extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (user.equals(usu.getRut_usuario())) {
                    boolean respuesta = Usuario_DB.ActualizarUsuarioCliente(u);
                    if (respuesta) {
