<%-- 
    Document   : empresac
    Created on : 18/04/2020, 05:22:41 PM
    Author     : lberr
--%>
                                ...
                                <div class="kt-widget__content">
                                    <div class="kt-widget__section">
                                        <%   
                                            ...
                                            String rute = usuario.getEmpresa().getRut_empresa();
                                        %>
                        ...
                        <div class="kt-portlet">
                            <div class="kt-portlet__head">
                                <div class="kt-portlet__head-label">
                                    <h3 class="kt-portlet__head-title">Información de Empresa <small>actualiza los datos relacionados a la empresa del usuario representante</small></h3>
                                </div>
                                        ...
                                        <div class="kt-section__body">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-9 col-xl-6">
                                                    <h3 class="kt-section__title kt-section__title-sm">Información de Empresa: </h3>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-xl-3 col-lg-3 col-form-label">Razon Social</label>
                                                <div class="col-lg-9 col-xl-6">
                                                    <input class="form-control" type="text" name="raz_empresa" id="raz_empresa" value="<%=usuario.getEmpresa().getRazon_social()%>">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-xl-3 col-lg-3 col-form-label">Pagina Web</label>
                                                <div class="col-lg-9 col-xl-6">
                                                    <input class="form-control" type="text" name="pag_empresa" id="pag_empresa" value="<%=usuario.getEmpresa().getPagina()  %>">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-xl-3 col-lg-3 col-form-label">Dirección</label>
                                                <div class="col-lg-9 col-xl-6">
                                                    <input class="form-control" type="text" name="dir_empresa" id="dir_empresa" value="<%=usuario.getEmpresa().getDireccion() %>">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-xl-6">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" name="tel_empresa" id="tel_empresa" value="<%=usuario.getEmpresa().getTelefono() %>" placeholder="Teléfono" >
                                                    </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-xl-6">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" name="cor_empresa" id="cor_empresa" value="<%=usuario.getEmpresa().getCorreo()%>" placeholder="Email" >
                                                        <input type="hidden" value="<%=rutu%>" id="rut_r" name="rut_r" >
                                                        <input type="hidden" value="<%=rute%>" id="rut_e" name="rut_e" >
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="kt-form__actions">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-9 col-xl-9">
                                                <button type="submit" id="kt_form_edit_empresa" class="btn btn-success">Guardar Cambios</button>&nbsp;                                    
                                            </div>
                                        </div>
                                    </div>
                                </div>
