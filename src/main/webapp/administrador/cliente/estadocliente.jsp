<%-- 
    Document   : estadocliente
    Created on : 18/04/2020, 05:22:17 PM
    Author     : lberr
--%>
                        ...
                        <div class="kt-portlet kt-portlet--height-fluid">
                            <div class="kt-portlet__head">
                                <div class="kt-portlet__head-label">
                                    <h3 class="kt-portlet__head-title">Cambiar Estado<small>cambia el estado de un cliente</small></h3>
                                </div>
                                                        ...
                                                        <label class="kt-option">
                                                            ...
                                                            <span class="kt-option__label">
                                                                ...
                                                                <span class="kt-option__body">
                                                                    ...
                                                                    toda actividad pendiente sera deshabilitada.
                                                                </span>
                                                            </span>
                                                        </label>
                                                    </div>
                                    ...
                                    <div class="kt-form__actions">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-9 col-xl-9">
                                                <button id="kt_form_change_status" type="submit"  class="btn btn-brand btn-bold">Cambiar Estado de Usuario</button>&nbsp;
                                            </div>
                                        </div>
                                    </div>
                                </div>
