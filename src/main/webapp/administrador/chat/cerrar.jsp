<%-- 
    Document   : cerrar
    Created on : 2/07/2020, 10:40:38 PM
    Author     : lberr
--%>
            ...
            <div class="col">
                <div class="alert alert-light alert-elevate fade show" role="alert">
                    ...
                    <div class="alert-text">
                        Al cerrar chat, dejara en conformidad la resolución por parte del profesional. 
                        <br>
                        Cada 30 días recuerde realizar una limpieza manual, En caso de problemas comunicarse con <a class="kt-link kt-font-bold" href="#" >Departamento TI.</a>.
                    </div>
                </div>
            </div>
        </div>
