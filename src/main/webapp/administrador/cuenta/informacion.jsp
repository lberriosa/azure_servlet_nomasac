                        ...
                        <div class="kt-widget kt-widget--user-profile-1">
                            <div class="kt-widget__head">
                                <div class="kt-widget__media">
                                    <img src="http://localhost:8080/nomasac/assets/media/users/admin.png" alt="image">
                                </div>
                                <div class="kt-widget__content">
                                    ...
                                    <div class="kt-widget__action">
                                        <a href="" class="btn btn-success btn-sm">Editar Datos</a>
                            ...
                            <div class="kt-widget__body">
                                <div class="kt-widget__content">
                                    <div class="kt-widget__info">
                                        ...
                                        <a href="#" class="kt-widget__data"><%=u.getCorreo_usuario()%></a>
                                    </div>
                                    <div class="kt-widget__info">
                                        <span class="kt-widget__label">Telefono:</span>
                                        <a href="#" class="kt-widget__data"><%=u.getTelefono_usuario()%></a>
                                    </div>
                                </div>
                                <div class="kt-widget__items">
                                    <a href="../cuenta/" class="kt-widget__item">
                                    ...
                                    <a href="password.jsp" class="kt-widget__item ">
                                        <span class="kt-widget__section">
                                            <span class="kt-widget__icon">
                                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <div class="col-xl-12">
                        <div class="kt-portlet">
                            <div class="kt-portlet__head">
                                <div class="kt-portlet__head-label">
                                    <h3 class="kt-portlet__head-title">Información Personal <small>actualiza tus datos personales</small></h3>
                                </div>
                                <div class="kt-portlet__head-toolbar">
                                    ...
                                    <div class="kt-section kt-section--first">
                                        <div class="kt-section__body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-xl-6">
                                                    <input class="form-control" type="text" name="nomb_admin" id="nomb_admin" value="<%=u.getNombre_usuario()%>">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-xl-3 col-lg-3 col-form-label">Apellidos</label>
                                                <div class="col-lg-9 col-xl-6">
                                                    <input class="form-control" type="text" name="app_admin" id="app_admin" value="<%=u.getApellido_usuario()%>">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-xl-3 col-lg-3 col-form-label">Dirección</label>
                                                <div class="col-lg-9 col-xl-6">
                                                    <input class="form-control" type="text" name="dire_admin" id="dire_admin" value="<%=u.getDireccion_usuario()%>">
                                                    <span class="form-text text-muted">Dirección sera corroborada de manera externa por el personal de recursos humanos.</span>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <label class="col-xl-3"></label>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-xl-6">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="tele_admin" id="tele_admin" class="form-control" value="<%=u.getTelefono_usuario()%>" placeholder="Teléfono" >
                                                    </div>
                                                    <span class="form-text text-muted">Se mantendra la privacidad de este dato para tu seguridad.</span>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-xl-6">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="corr_admin" id="corr_admin" class="form-control" value="<%=u.getCorreo_usuario()%>" placeholder="Email" >
                                    ...
                                    <div class="kt-form__actions">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-9 col-xl-9">
                                                <button type="submit" id="kt_form_edit_admin" class="btn btn-success">Guardar Cambios</button>&nbsp;                                    
                                            </div>
                                        </div>
                                    </div>
                                </div>
