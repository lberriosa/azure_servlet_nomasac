<%-- 
    Document   : cancelarv
    Created on : 19/06/2020, 10:45:42 PM
    Author     : lberr
--%>
            ...
            <div class="col">
                <div class="alert alert-light alert-elevate fade show" role="alert">
                    ...
                    <div class="alert-text">
                        Al cancelar esta actividad, no tendra derecho a reactivar ni gestionar. Se contara como actividad "realizada", por lo cual, fiscalización quedara evaluado como finalizado.  
                        <br>
