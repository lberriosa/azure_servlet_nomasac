<%-- 
    ...
    Created on : 20/06/2020, 01:00:55 AM
    Author     : lberr
--%>
        ...
        <div class="kt-subheader__main">
            ...
            <div class="kt-subheader__group" id="kt_subheader_search">
                <span class="kt-subheader__desc" id="kt_subheader_total">
                    Reprograma una visita a la empresa de un cliente activo en sistema. </span>
            </div>
        </div>
    ...
    <div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
            ...
            <div class="col">
                <div class="alert alert-light alert-elevate fade show" role="alert">
                    ...
                    <div class="alert-text">
                        Toda reprogramación sera avisada por correo electronico a cliente. Al ser un caso especial se podra reprogramar las veces necesarias para aliviar el suceso.
                        <br>
        ...
        <div class="kt-portlet">
            <div class="kt-portlet__body kt-portlet__body--fit">
                <div class="kt-grid  kt-wizard-v2 kt-wizard-v2--white" id="kt_wizard_v15" data-ktwizard-state="step-first">
                    ...
                    <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v2__wrapper">
                        ...
                        <form class="kt-form" id="visitfisc_rform">
