<%-- 
    Document   : index
    Created on : 19/06/2020, 12:21:22 AM
    Author     : lberr
--%>
    ...
    <div class="kt-subheader   kt-grid__item" id="kt_subheader">
        <div class="kt-subheader__main">
            <h3 class="kt-subheader__title">
                Gestionar Fiscalización </h3>
            <span class="kt-subheader__separator kt-subheader__separator--v"></span>
            <div class="kt-subheader__group" id="kt_subheader_search">
                <span class="kt-subheader__desc" id="kt_subheader_total">
                    Visualiza y gestionar las fiscalizaciones registradas en sistema </span>
            </div>
        ...
        <div class="kt-portlet kt-portlet--mobile">
            ...
            <div class="kt-portlet__body">
                ...
                <table id="tabla_alertafis" class="table table-striped- table-bordered table-hover table-checkable" style="width:100%">
                    ...
                    <tbody>
                        <%                            ArrayList<Alerta> lista = Alerta_DB.obtenerFiscalizaciones();
