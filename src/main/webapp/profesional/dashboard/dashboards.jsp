<%-- 
    Document   : dashboards
    Created on : 9/07/2020, 06:04:03 PM
    Author     : lberr
--%>
                        ...
                        <div class="kt-widget17__visual kt-widget17__visual--chart kt-portlet-fit--top kt-portlet-fit--sides" style="background-color: #fd397a">
                            <div class="kt-widget17__chart" style="height:320px;">
                                <canvas id="kt_chart_activities"></canvas>
                                    <%
                                        ArrayList<Estadistica> lista = Estadistica_BD.totalActivxMes_Sup();
                                        String json = new Gson().toJson(lista);

                                        int t_visitas = Estadistica_BD.t_Visitas_Sup();
                                        int t_acciden = Estadistica_BD.t_Accid_Sup();
                                        int t_fiscali = Estadistica_BD.t_Fisca_Sup();
                                        int t_mejoras = Estadistica_BD.t_Mejora_Sup();
                                    %>
        ...
        <div class="col-xl-4">
            ...
            <div class="kt-portlet kt-portlet--fit kt-portlet--head-noborder kt-portlet--height-fluid-half">
                <div class="kt-portlet__head kt-portlet__space-x">
                    ...
                    <%
                        int t_asisten_s = Estadistica_BD.t_CAsisten_Sup();
                        ArrayList<Estadistica> lista2 = Estadistica_BD.totalAsisxMes_Sup();
                        String json2 = new Gson().toJson(lista2);
                    %>
                </div>
                <input type="hidden" value='<%=json2%>' id="e_t_asistesxm">

                    <div class="kt-portlet__body kt-portlet__body--fluid">
                        <div class="kt-widget20">
                            <div class="kt-widget20__content kt-portlet__space-x">
                                <span class="kt-widget20__number kt-font-brand"><%=t_asisten_s%></span>
            ...
            <div class="kt-portlet kt-portlet--fit kt-portlet--head-noborder kt-portlet--height-fluid-half">
                <div class="kt-portlet__head kt-portlet__space-x">
                    ...
                    <%
                        int t_clientes = Estadistica_BD.t_UsuariosA_Sup();
                        ArrayList<Estadistica> lista3 = Estadistica_BD.totalContraCre_Sup();
                        String json3 = new Gson().toJson(lista3);
                    %>
                </div>
                <input type="hidden" value='<%=json3%>' id="e_t_clientesacm">

                    <div class="kt-portlet__body kt-portlet__body--fluid">
                        <div class="kt-widget20">
                            <div class="kt-widget20__content kt-portlet__space-x">
                                <span class="kt-widget20__number kt-font-danger"><%=t_clientes%></span>
