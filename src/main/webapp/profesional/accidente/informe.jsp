<%-- 
    Document   : informe
    Created on : 20/06/2020, 11:11:40 PM
    Author     : lberr
--%>
...
<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
    ...
    <div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
        ...
        <div class="kt-portlet">
            ...
            <!--begin::Form-->
            <form class="kt-form" id="reporteaform" enctype="multipart/form-data">
                    ...
                    <div class="kt-form__actions">
                        <div class="row">
                            ...
                            <div class="col-lg-9 col-xl-9">
                                <button id="kt_form_ingresar_repo" type="submit"  class="btn btn-brand btn-bold">Ingresar Reporte</button>&nbsp;
                            </div>
                        </div>
                    </div>
                </div>
