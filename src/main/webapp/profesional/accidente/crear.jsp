<%-- 
    Document   : crear
    Created on : 19/06/2020, 01:55:54 PM
    Author     : lberr
--%>
        ...
        <div class="kt-subheader__main">
            ...
            <div class="kt-subheader__group" id="kt_subheader_search">
                <span class="kt-subheader__desc" id="kt_subheader_total">
                    Genera la creación de una visita a la empresa de un informe de accidente. </span>
            </div>
        </div>
    ...
    <div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
        ...
        <div class="kt-portlet">
            <div class="kt-portlet__body kt-portlet__body--fit">
                <div class="kt-grid  kt-wizard-v2 kt-wizard-v2--white" id="kt_wizard_v11" data-ktwizard-state="step-first">
                    ...
                    <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v2__wrapper">
                        ...
                        <form class="kt-form" id="caccidente_form">
