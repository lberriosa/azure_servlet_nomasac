<%-- 
    Document   : cancelarv
    Created on : 19/06/2020, 10:31:49 PM
    Author     : lberr
--%>
...
<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
    ...
    <div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
            ...
            <div class="col">
                <div class="alert alert-light alert-elevate fade show" role="alert">
                    ...
                    <div class="alert-text">
                        Al cancelar esta actividad, no tendra derecho a reactivar ni gestionar. Se contara como actividad "realizada", por lo cual, accidente quedara evaluado como finalizado.  
                        <br>
        ...
        <div class="kt-portlet">
            ...
            <!--begin::Form-->
            <form class="kt-form kt-form--fit kt-form--label-right" id="cancelaaccidente">
                    ...
                    <div class="kt-form__actions">
                        <div class="row">
                            <div class="col-lg-9 ml-lg-auto">
                                ...
                                <button type="submit" data-ktwizard-type="action-submit" class="btn btn-brand">Cancelar Visita - Actividad</button>
                            </div>
                        </div>
                    </div>
                </div>
