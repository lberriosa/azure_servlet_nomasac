<%-- 
    Document   : password
    Created on : 27/05/2020, 10:10:26 PM
    Author     : lberr
--%>
                        ...
                        <div class="kt-widget kt-widget--user-profile-1">
                            ...
                            <div class="kt-widget__body">
                                ...
                                <div class="kt-widget__items">
                                    ...
                                    <a href="informacion.jsp" class="kt-widget__item ">
                                        <span class="kt-widget__section">
                                            <span class="kt-widget__icon">
                                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <div class="col-xl-12">
                        <div class="kt-portlet kt-portlet--height-fluid">
                            <div class="kt-portlet__head">
                                <div class="kt-portlet__head-label">
                                    <h3 class="kt-portlet__head-title">Cambiar Contraseña<small>cambia tu contraseña</small></h3>
                                </div>
                                    ...
                                    <div class="kt-section kt-section--first">
                                        <div class="kt-section__body">
                                            <div class="alert alert-text alert-bold fade show kt-margin-t-20 kt-margin-b-40" role="alert">
                                                ...
                                                <div class="alert-text">Debido a nuestros terminos de seguridad recomendamos que cambies tu contraseña periodicamente. </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-9 col-xl-6">
                                                    <h3 class="kt-section__title kt-section__title-sm">Cambia tu contraseña:</h3>
                                                </div>
                                            </div>

                                            <div class="form-group row">
                                                <label class="col-xl-3 col-lg-3 col-form-label">Ingresa tu Contraseña</label>
                                                <div class="col-lg-9 col-xl-6">
                                                    <input type="password" class="form-control" placeholder="Contraseña" id="password_r" name="password_r">
                                                </div>
                                            </div>
                                            <div class="form-group form-group-last row">
                                                <label class="col-xl-3 col-lg-3 col-form-label">Repite tu Contraseña</label>
                                                <div class="col-lg-9 col-xl-6">
