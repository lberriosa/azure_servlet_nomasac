<%-- 
    ...
    Created on : 27/05/2020, 10:10:19 PM
    Author     : lberr
--%>
                                ...
                                <div class="kt-portlet__body">
                                    <div class="kt-section kt-section--first">
                                        <div class="kt-section__body">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-xl-3 col-lg-3 col-form-label">Profesion</label>
                                                <div class="col-lg-9 col-xl-6">
                                                    <input class="form-control" type="text" readonly name="app_prof" id="app_prof" value="<%=u.getProfesion() %>">
                                                </div>
                                            </div>
                                            <div class="form-group row">
