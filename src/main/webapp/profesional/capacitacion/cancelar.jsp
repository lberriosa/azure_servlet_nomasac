<%-- 
    Document   : cancelar
    Created on : 3/07/2020, 09:56:42 PM
    Author     : lberr
--%>
...
<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
        ...
        <div class="kt-subheader__main">
            ...
            <div class="kt-subheader__group" id="kt_subheader_search">
                <span class="kt-subheader__desc" id="kt_subheader_total">
                    Solicita la cancelación de una capacitacion a terreno. </span>
            </div>
        </div>
    ...
    <div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
            ...
            <div class="col">
                <div class="alert alert-light alert-elevate fade show" role="alert">
                    ...
                    <div class="alert-text">
                        Al cancelar esta actividad, no tendra derecho a reactivar la capacitación. Se contara como actividad "realizada".  
                        <br>
        ...
        <div class="kt-portlet">
            ...
            <!--begin::Form-->
            <form class="kt-form kt-form--fit kt-form--label-right" id="cancelcapaci">
                                ...
                                <div class="kt-wizard-v4__review">
                                    <div class="kt-wizard-v4__review-item">
                                        ...
                                        <div class="kt-wizard-v4__review-content">
                                            <div>Fecha Capacitación : <%=acti.getFecha_inicio()%></div>
