<%-- 
    Document   : index
    Created on : 3/07/2020, 12:30:20 AM
    Author     : lberr
--%>
    ...
    <div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
        ...
        <div class="kt-portlet kt-portlet--mobile">
            ...
            <div class="kt-portlet__body">
                ...
                <!--begin: Datatable -->
                <table id="tabla_capacitap" class="table table-striped- table-bordered table-hover table-checkable" style="width:100%">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <%                            
                            ArrayList<Actividad> lista = Actividad_DB.obtenerCapacitaciones();
                        ...
                        <tr>
                            ...
                            <td><span class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a class="dropdown-item" href="informe.jsp?id=<%=act.getId_actividad()%>"><i class="la la-edit"></i> Ingresar Informe</a> 
                                    </div>
                                </span>
                            </td>
                            <%
