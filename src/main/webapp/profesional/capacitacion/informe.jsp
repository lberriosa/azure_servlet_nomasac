<%-- 
    Document   : informe
    Created on : 3/07/2020, 11:55:07 PM
    Author     : lberr
--%>
...
<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
        ...
        <div class="kt-subheader__main">
            ...
            <div class="kt-subheader__group" id="kt_subheader_search">
                <span class="kt-subheader__desc" id="kt_subheader_total">
                    Ingrese informe correspondiente a la visita realizada. </span>
            </div>
        </div>
    ...
    <div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
            ...
            <div class="col">
                <div class="alert alert-light alert-elevate fade show" role="alert">
                    ...
                    <div class="alert-text">
                        Al ingresar informe correspondiente verifique los datos, ya que seran visibles de inmediato para el cliente.  
                        <br>
        ...
        <div class="kt-portlet">
            ...
            <!--begin::Form-->
            <form class="kt-form" id="informe_form" enctype="multipart/form-data">
                <div class="kt-portlet__body">
                    <div class="kt-section kt-section--first">
                        <div class="kt-section__body">
                            <div class="alert alert-text alert-bold fade show kt-margin-t-20 kt-margin-b-40" role="alert">
                                <div class="alert-icon"><i class="fas fa-info-circle"></i></div>
                                <div class="alert-text">Al ingresar informe ya no podra reintentar operación en sistema.  </div>
                                    ...
                                    <div class="kt-wizard-v2__form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="custom-file">
                                                ...
                                                <label class="custom-file-label" for="customFile">Buscar Informe</label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <span class="form-text text-muted">Ingrese alguna observación acerca del informe.</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="kt-form__actions">
                        <div class="row">
                            ...
                            <div class="col-lg-9 col-xl-9">
                                <button id="kt_form_ing_informe" type="submit"  class="btn btn-brand btn-bold">Ingresar Informe</button>&nbsp;
                            </div>
                        </div>
                    </div>
                </div>
