<%-- 
    Document   : crear
    Created on : 28/05/2020, 04:56:50 PM
    Author     : lberr
--%>
        ...
        <div class="kt-subheader__main">
            ...
            <div class="kt-subheader__group" id="kt_subheader_search">
                <span class="kt-subheader__desc" id="kt_subheader_total">
                    Genera la creación de una visita a la empresa de un cliente activo en sistema. </span>
            </div>
        </div>
            ...
            <div class="col">
                <div class="alert alert-light alert-elevate fade show" role="alert">
                    ...
                    <div class="alert-text">
                        Cliente solo debe tener dos visitas al mes. Estas no pueden ser en un mismo día.
                        <br>
            ...
            <div class="kt-portlet__body kt-portlet__body--fit">
                <div class="kt-grid  kt-wizard-v2 kt-wizard-v2--white" id="kt_wizard_v2" data-ktwizard-state="step-first">
                    ...
                    <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v2__wrapper">
                        ...
                        <form class="kt-form" id="visita_form">
