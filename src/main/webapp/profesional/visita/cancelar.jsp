<%-- 
    Document   : cancelar
    Created on : 31/05/2020, 12:39:56 PM
    Author     : lberr
--%>
...
<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
        ...
        <div class="kt-subheader__main">
            ...
            <div class="kt-subheader__group" id="kt_subheader_search">
                <span class="kt-subheader__desc" id="kt_subheader_total">
                    Solicita la cancelación de una visita a terreno. </span>
            </div>
        </div>
    ...
    <div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
            ...
            <div class="col">
                <div class="alert alert-light alert-elevate fade show" role="alert">
                    ...
                    <div class="alert-text">
                        Al cancelar esta actividad, no tendra derecho a reactivar la visita. Se contara como actividad "realizada" ,por lo cual, si ya posee una visita creada aparte, no podra gestionar otra visita durante el mes.  
                        <br>
        ...
        <div class="kt-portlet">
            ...
            <!--begin::Form-->
            <form class="kt-form kt-form--fit kt-form--label-right" id="cancelv">
                    ...
                    <div class="kt-form__actions">
                        <div class="row">
                            <div class="col-lg-9 ml-lg-auto">
                                ...
                                <button type="submit" data-ktwizard-type="action-submit" class="btn btn-brand">Cancelar Visita</button>
                            </div>
                        </div>
                    </div>
                </div>
