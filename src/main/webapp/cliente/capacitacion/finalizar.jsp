<%-- 
    Document   : finalizar
    Created on : 3/07/2020, 11:21:51 PM
    Author     : lberr
--%>
...
<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
    ...
    <div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
        ...
        <div class="kt-portlet">
            ...
            <!--begin::Form-->
            <form class="kt-form kt-form--fit kt-form--label-right" id="endcapaci">
                    ...
                    <div class="kt-form__actions">
                        <div class="row">
                            <div class="col-lg-9 ml-lg-auto">
                                ...
                                <button type="submit" data-ktwizard-type="action-submit" class="btn btn-brand">Finalizar Capacitación</button>
                            </div>
                        </div>
                    </div>
                </div>
