<%-- 
    Document   : index
    Created on : 17/06/2020, 09:37:12 PM
    Author     : lberr
--%>
        ...
        <div class="kt-subheader__main">
            ...
            <div class="kt-subheader__group" id="kt_subheader_search">
                <span class="kt-subheader__desc" id="kt_subheader_total">
                    Visualiza y gestiona los accidentes registrados en sistema </span>
            </div>
        ...
        <div class="kt-portlet kt-portlet--mobile">
            ...
            <div class="kt-portlet__body">
                ...
                <table id="tabla_alertaacc" class="table table-striped- table-bordered table-hover table-checkable" style="width:100%">
                    ...
                    <tbody>
                        <%                            
                            ArrayList<Alerta> lista = Alerta_DB.obtenerAccidentesXRut(codigo);
