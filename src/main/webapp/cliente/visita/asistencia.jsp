<%-- 
    Document   : asistencia
    Created on : 1/06/2020, 10:23:12 PM
    Author     : lberr
--%>
...
<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
    ...
    <div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
            ...
            <div class="col">
                <div class="alert alert-light alert-elevate fade show" role="alert">
                    ...
                    <div class="alert-text">
                        Si marca inasistencia y ya posee una visita creada aparte, no podra gestionar otra visita durante el mes. Actividad actual sera cancelada  
                        <br>
        ...
        <div class="kt-portlet">
            ...
            <!--begin::Form-->
            <form class="kt-form" id="asistencc">
                    ...
                    <div class="kt-form__actions">
                        <div class="row">
                            ...
                            <div class="col-lg-9 col-xl-9">
                                <button id="kt_form_mark_asistencia" type="submit"  class="btn btn-brand btn-bold">Marcar Asistencia</button>&nbsp;
                            </div>
                        </div>
                    </div>
                </div>
