                        ...
                        <div class="kt-widget kt-widget--user-profile-1">
                            <div class="kt-widget__head">
                                <div class="kt-widget__media">
                                    <img src="http://localhost:8080/nomasac/assets/media/users/cliente-p.png" alt="image">
                                </div>
                    ...
                    <div class="col-xl-12">
                        <div class="kt-portlet">
                            <div class="kt-portlet__head">
                                <div class="kt-portlet__head-label">
                                    <h3 class="kt-portlet__head-title">Información Personal <small>aquí podrá revisar sus datos personales</small></h3>
                                </div>
                                <div class="kt-portlet__head-toolbar">
                                    ...
                                    <div class="kt-section kt-section--first">
                                        <div class="kt-section__body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-xl-6">
                                                    <input class="form-control" type="text" readonly name="nomb_admin" id="nomb_admin" value="<%=u.getNombre_usuario()%>">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-xl-3 col-lg-3 col-form-label">Apellidos</label>
                                                <div class="col-lg-9 col-xl-6">
                                                    <input class="form-control" type="text" readonly name="app_admin" id="app_admin" value="<%=u.getApellido_usuario()%>">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-xl-3 col-lg-3 col-form-label">Dirección</label>
                                                <div class="col-lg-9 col-xl-6">
                                                    <input class="form-control" type="text" readonly name="dire_admin" id="dire_admin" value="<%=u.getDireccion_usuario()%>">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-xl-6">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="tele_admin" readonly id="tele_admin" class="form-control" value="<%=u.getTelefono_usuario()%>" placeholder="Teléfono" >
                                                    </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-xl-6">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="corr_admin" readonly id="corr_admin" class="form-control" value="<%=u.getCorreo_usuario()%>" placeholder="Email" >
