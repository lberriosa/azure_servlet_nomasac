...
<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
    ...
    <div class="kt-subheader   kt-grid__item" id="kt_subheader">
        <div class="kt-subheader__main">
            ...
            <h3 class="kt-subheader__title">Cliente</h3>
    ...
    <!-- end:: Content Head -->
    <!-- begin:: Content -->
    <%            Contrato contr = Contrato_DB.BuscarContrato(codigo);
        if (con.getFolio_contrato() != 0 && con.getEstado() == 1) {
    %> 
                            ...
                            <div class="kt-widget17__visual kt-widget17__visual--chart kt-portlet-fit--top kt-portlet-fit--sides" style="background-color: #fd397a">
                                <div class="kt-widget17__chart" style="height:320px;">
                                    <canvas id="kt_chart_activities"></canvas>
                                        <%
                                            ArrayList<Estadistica> lista = Estadistica_BD.totalActividad_Cli(codigo);
                                            String json = new Gson().toJson(lista);

                                            int t_visitas = Estadistica_BD.t_Visit_Cli(codigo);
                                            int t_asisten = Estadistica_BD.t_Asis_Cli(codigo);
                                            int t_alertas = Estadistica_BD.t_Alert_Cli(codigo);
                                            int t_capacit = Estadistica_BD.t_Capaci_Cli(codigo);
                                        %>
                ...
                <div class="kt-portlet kt-portlet--fit kt-portlet--head-noborder kt-portlet--height-fluid-half">
                    <div class="kt-portlet__head kt-portlet__space-x">
                        ...
                        <%
                            ...
                            ArrayList<Estadistica> lista2 = Estadistica_BD.totalActivXmes_Cli(codigo);
                            String json2 = new Gson().toJson(lista2);
                        %>
                    </div>
                    <input type="hidden" value='<%=json2%>' id="e_t_actividadesprom">
                ...
                <div class="kt-portlet kt-portlet--fit kt-portlet--head-lg kt-portlet--head-overlay kt-portlet--skin-solid kt-portlet--height-fluid">
                    ...
                    <div class="kt-portlet__body kt-portlet__body--fit">
                        <div class="kt-widget17">
                            <div class="kt-widget17__visual kt-widget17__visual--chart kt-portlet-fit--top kt-portlet-fit--sides" style="background-color: #fd397a">
                                <div class="kt-widget17__chart" style="height:320px;">
                                    <canvas id="kt_chart_monetario"></canvas>  
                                        <%
                                            int t_fondos = Estadistica_BD.t_Fondos_Cli(codigo);
                                            int t_pagado = Estadistica_BD.t_Pagado_Cli(codigo);
                                            int t_debe = Estadistica_BD.t_Debe_Cli(codigo);
                                            int t_cpagos = Estadistica_BD.t_CPagos_Cli(codigo);

                                            ArrayList<Estadistica> lista3 = Estadistica_BD.totalPagosXmes_Cli(codigo);
                                            String json3 = new Gson().toJson(lista3);
                                        %>    
                                </div>
                                <input type="hidden" value='<%=json3%>' id="e_t_pagoxm">
                            </div>
                            <div class="kt-widget17__stats">
                                <div class="kt-widget17__items">
                                    <div class="kt-widget17__item">
