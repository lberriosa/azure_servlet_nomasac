<%-- 
    Document   : asistencia
    Created on : 20/06/2020, 04:23:56 PM
    Author     : lberr
--%>
...
<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
    ...
    <div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
        ...
        <div class="kt-portlet">
            ...
            <!--begin::Form-->
            <form class="kt-form" id="asistenciac_alf">
                    ...
                    <div class="kt-form__actions">
                        <div class="row">
                            ...
                            <div class="col-lg-9 col-xl-9">
                                <button id="kt_form_mark_asistencia_alf" type="submit"  class="btn btn-brand btn-bold">Marcar Asistencia</button>&nbsp;
                            </div>
                        </div>
                    </div>
                </div>
