...
var KTWreprogramar = function () {
    ...
    var initWizard = function () {
        ...
        wizard = new KTWizard('kt_wizard_v9', {
            startStep: 1,
        });
                        ...
                        switch (data) {
                            ...
                            case'IngresadoCobro':
                                setTimeout(function () {
                                    ...
                                    swal.fire({
                                        "title": "",
                                        "text": "Se reprogramo la visista de manera correcta en el sistema! Se realizo un cobro extra de $50.000",
                                        "type": "success",
                                        "confirmButtonClass": "btn btn-secondary"
                                    }).then(function () {
                                        window.location = "http://localhost:8080/nomasac/cliente/visita/";
    ...
    return {
        // public functions
        init: function () {
            wizardEl = KTUtil.get('kt_wizard_v9');
            formEl = $('#visita_rform');
