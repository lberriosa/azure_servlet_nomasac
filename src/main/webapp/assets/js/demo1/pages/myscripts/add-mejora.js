...
var KTInserMejo = function () {
    ...
    var handleEdit = function () {
        $('#kt_form_ingresar_mjra').click(function (e) {
            e.preventDefault();
            ...
            if (document.getElementById("file").files.length === 0) {
                ...
                form_data.append('nombre', nomb);
                form_data.append('rut_usuario', iuser);
                form_data.append('rut_profes', ipro);
            }
                        ...
                        case'Ingresado':
                            setTimeout(function () {
                                if (elem !== null) {
                                    ...
                                    showErrorMsg(form, 'success', 'Se ingreso correctamente mejora en sistema. Cambios seran reflejados a la brevedad');
                                } else {
                                    btn.removeClass('kt-spinner kt-spinner--right kt-spinner--sm kt-spinner--light').attr('disabled', false);
                                    showErrorMsg(form, 'success', 'Se ingreso correctamente mejora en sistema. Cambios seran reflejados a la brevedad');
                                }
