...
var KTInserRpF = function () {
    ...
    var handleEdit = function () {
        $('#kt_form_ingresar_repof').click(function (e) {
            e.preventDefault();
                        ...
                        case'Ingresado':
                            setTimeout(function () {
                                if (elem !== null) {
                                    ...
                                    showErrorMsg(form, 'success', 'Se ingreso correctamente reporte en sistema. Cambios seran reflejados a la brevedad');
                                } else {
                                    btn.removeClass('kt-spinner kt-spinner--right kt-spinner--sm kt-spinner--light').attr('disabled', false);
                                    showErrorMsg(form, 'success', 'Se ingreso correctamente reporte en sistema. Cambios seran reflejados a la brevedad');
                                }
                                ...
                                swal.fire({
                                    ...
                                    window.location = "http://localhost:8080/nomasac/profesional/fiscalizacion/";
                                });
