...
var KTWreprogramarf = function () {
    ...
    var initWizard = function () {
        ...
        wizard = new KTWizard('kt_wizard_v15', {
            startStep: 1,
        });
    ...
    return {
        // public functions
        init: function () {
            wizardEl = KTUtil.get('kt_wizard_v15');
            formEl = $('#visitfisc_rform');
