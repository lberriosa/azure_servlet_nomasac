...
var KTWreprogramarfc = function () {
    ...
    var initWizard = function () {
        ...
        wizard = new KTWizard('kt_wizard_v25', {
            startStep: 1,
        });
    ...
    return {
        // public functions
        init: function () {
            wizardEl = KTUtil.get('kt_wizard_v25');
            formEl = $('#visitfiscc_rform');
