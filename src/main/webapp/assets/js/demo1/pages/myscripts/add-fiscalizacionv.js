...
var KTaddvfis = function () {
    ...
    var initWizard = function () {
        ...
        wizard = new KTWizard('kt_wizard_v14', {
            startStep: 1,
        });
    ...
    var initSubmit = function () {
        ...
        btn.on('click', function (e) {
            ...
            if (validator.form()) {
                ...
                formEl.ajaxSubmit({
                    type: "POST",
                    url: '../../Servlet_CrearVFiscali',
                    data: {"descv": desc, "fechav": fec, "rut_usuario": rutp, "id_accidente":ida,"id_actividad":idac},
    ...
    return {
        // public functions
        init: function () {
            wizardEl = KTUtil.get('kt_wizard_v14');
            formEl = $('#cfisca_form');
