...
var KTAccidente = function () {
    ...
    var handlePassword = function () {
        $('#kt_form_mark_accidente').click(function (e) {
            e.preventDefault();
            ...
            swalWithBootstrapButtons.fire({
                title: 'Desea informar accidente?',
                                ...
                                case'Creado':
                                    setTimeout(function () {
                                        if (elem !== null) {
                                            ...
                                            showErrorMsg(form, 'success', 'Se informo correctamente el accidente. Supervisor evaluara visita a su empresa');
                                            swal.fire({
                                                "title": "",
                                                "text": "Se informo correctamente accidente en sistema !",
                                                "type": "success",
                                ...
                                case'Limite':
                                    setTimeout(function () {
                                        if (elem !== null) {
                                            ...
                                            swal.fire({
                                                "title": "",
                                                "text": "Ocurrio un error al informar accidente en sistema. Supera la cantidad máxima de informes",
                                                "type": "error",
                                                "buttonStyling": false,
                                ...
                                case'Error':
                                    setTimeout(function () {
                                        if (elem !== null) {
                                            ...
                                            swal.fire({
                                                "title": "",
                                                "text": "Ocurrio un error al informar accidente en sistema. Reintente mas tarde",
                                                "type": "error",
                                                "buttonStyling": false,
                                                "confirmButtonClass": "btn btn-brand btn-sm btn-bold"
                                            });
