...
var KTDashboard = function() {
    ...
    var activitiesChart = function() {
        ...
        var cantidad =[];
        var data = {};
        data.total = jQuery.parseJSON($('#e_esta_t').val());
    ...
    // Activities Charts.
    // Based on Chartjs plugin - http://www.chartjs.org/
    var rendimientoChart = function() {
        if ($('#kt_chart_rendimiento').length == 0) {
            return;
        }
        ...
        var cantidad4 =[];
        var data4 = {};
        data4.total = jQuery.parseJSON($('#e_t_rendim').val());

        data4.total.forEach(function(item) {
            meses4.push(item.mes);
            cantidad4.push(item.cantidad);
        });
  
        console.log(data4);
  
        var ctx = document.getElementById("kt_chart_rendimiento").getContext("2d");
        ...
        // Activities Charts.
    // Based on Chartjs plugin - http://www.chartjs.org/
    var fondomonetarioChart = function() {
        if ($('#kt_chart_monetario').length == 0) {
            return;
        }
        ...
        var cantidad6 =[];
        var data6 = {};
        data6.total = jQuery.parseJSON($('#e_t_pagoxm').val());

        data6.total.forEach(function(item) {
            meses6.push(item.mes);
            cantidad6.push(item.cantidad);
        });
  
        console.log(data6);
  
        var ctx = document.getElementById("kt_chart_monetario").getContext("2d");
    ...
    var bandwidthChart1 = function() {
        ...
        var cantidad2 =[];
        var data2 = {};
        data2.total = jQuery.parseJSON($('#e_t_contratosm').val());

        data2.total.forEach(function(item) {
            meses2.push(item.mes);
            cantidad2.push(item.cantidad);
        });
    ...
    var bandwidthChart2 = function() {
        ...
        var cantidad3 =[];
        var data3 = {};
        data3.total = jQuery.parseJSON($('#e_t_pagosm').val());

        data3.total.forEach(function(item) {
            meses3.push(item.mes);
    ...
    var bandwidthChart3 = function() {
        ...
        var cantidad5 =[];
        var data5 = {};
        data5.total = jQuery.parseJSON($('#e_t_actividadesprom').val());

        data5.total.forEach(function(item) {
            meses5.push(item.mes);
            cantidad5.push(item.cantidad);
        });
    ...
    var bandwidthChart4 = function() {
        if ($('#kt_chart_bandwidth4').length == 0) {
            return;
        }
        ...
        var cantidad7 =[];
        var data7 = {};
        data7.total = jQuery.parseJSON($('#e_t_asistesxm').val());

        data7.total.forEach(function(item) {
            meses7.push(item.mes);
            cantidad7.push(item.cantidad);
        });
    ...
    // Bandwidth Charts 2.
    // Based on Chartjs plugin - http://www.chartjs.org/
    var bandwidthChart5 = function() {
        if ($('#kt_chart_bandwidth5').length == 0) {
            return;
        }
        ...
        var cantidad8 =[];
        var data8 = {};
        data8.total = jQuery.parseJSON($('#e_t_clientesacm').val());

        data8.total.forEach(function(item) {
            meses8.push(item.mes);
            cantidad8.push(item.cantidad);
        });
  
        console.log(data8); 

        var ctx = document.getElementById("kt_chart_bandwidth5").getContext("2d");
